...
- All TypeScript source code (`*.ts` files).
- Plugin configuration handling and environment variable processing.
- Dependencies declared in `package.json`.
- Hooks and command handlers.
...
- Issues that require physical access to a machine running the tool.
